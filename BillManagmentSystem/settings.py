"""
Django settings for BillManagmentSystem project.
...
SECRET_KEY = 'django-insecure-f3p#9=maidwlcy)(d)l9b6azrsx5%9q(a@fl&k)_wfd=2n)c-#'
...
ROOT_URLCONF = 'BillManagmentSystem.urls'
...
WSGI_APPLICATION = 'BillManagmentSystem.wsgi.application'
